...
| `collapseOnDoubleClick`                 | `bool`                 |                                                                                        |           | `true`                                                        | Toggles ability to collapse/expand the tree's nodes by double-clicking them. If set to `false`, a single click will collapse/expand them if `collapsible` is set to `true`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
